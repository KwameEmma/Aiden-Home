...
<div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary">Manage Rooms</h3> </div>
                                ...
                                <div class="form-validation">
                                    ...
                                    <form class="form-valide"  method="post" action="pages/save_room.php" enctype="multipart/form-data">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="number" class="form-control" id="val-username" name="floorno" placeholder="Enter a floor number" required="">
                                            </div>
                                        </div>

                                        <div class="form-group row">
                                            <label class="col-lg-4 col-form-label" for="val-username">Room Name : <span class="text-danger">*</span></label>
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control" id="val-username" name="roomname" placeholder="Enter a room name" required="">
                                            </div>
                                        </div>
