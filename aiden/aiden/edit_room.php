...
if(isset($_POST["submit"]))
{
 ...
 if (move_uploaded_file($_FILES['image']['tmp_name'], $target)) {
  @unlink("uploadImage/Profile/".$_POST['old_image']);
      ...
      $q1="UPDATE `tbl_rooms` SET `floorno`='$floorno',`roomname`='$roomname' WHERE `id`='".$_GET['id']."'";
    //$q2=$conn->query($q1);
                                ...
                                <div class="form-validation">
                                    ...
                                    <form class="form-valide"  method="post"  enctype="multipart/form-data"> 
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="number" class="form-control" id="val-username" name="floorno" value="<?php echo $floorno; ?>" required="">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control" id="val-digits" name="roomname" value="<?php echo $roomname; ?>"  required="">
                                            </div>
                                        </div>
