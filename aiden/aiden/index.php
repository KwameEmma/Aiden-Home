        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row justify">
                    <div class="col-md-12">
                        <div class="card p-30">
                            <div class="box box-danger" style="height: auto;z-index:1500px">
                                <div class="box-body">
                                  <!-- THE CALENDAR -->
                                  <div id="calendar">
...
<script>
  ...
  $display_appoint=array();
   while($row = $result->fetch_assoc()) { 
    $sql2 = "SELECT * FROM `tbl_customer` WHERE id='".$row['customerid']."'";
    $result2=$conn->query($sql2);
    $row2=$result2->fetch_assoc();
    $sql3 = "SELECT * FROM `tbl_rooms` WHERE id='".$row['roomid']."'";
    ...
    $('#calendar').fullCalendar({
      ...
      <?php foreach ($display_appoint as $value) { ?>
        {
          title          : '<?php echo $value['name'], " - " .addslashes($value['roomname'])?>',
