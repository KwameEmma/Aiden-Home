...
if(isset($_POST["submit"]))
{
 ...
 if (move_uploaded_file($_FILES['image']['tmp_name'], $target)) {
  @unlink("uploadImage/Profile/".$_POST['old_image']);
      ...
      $q1="UPDATE `tbl_customer` SET `name`='$name',`email`='$email',`gender`='$gender',`contact`='$contact',`address`='$address' WHERE `id`='".$_GET['id']."'";
    //$q2=$conn->query($q1);
                                ...
                                <div class="form-validation">
                                    <form class="form-valide"  method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control" id="val-phoneus" name="contact" value="<?php echo $contact; ?>" minlength="10" maxlength="10" required="">
                                            </div>
                                        </div>
                                        <div class="form-group row">
